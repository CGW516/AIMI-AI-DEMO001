...
主要是在Demos里面加了个 Electron

- Demos/electronapp 目录下是一个简单的 Electron 应用，用于展示弹幕内容。
- 添加了语音播放、弹幕播放、感谢礼物


简单做了个示例、慢慢完善中，有问题可以提issue


不过打包的时候需要自己设置一些文件路径之类的，或者把包放在当前目录，有问题可以提issue
...
npm install --save-dev electron@36.1.0
# 如果报错
npm  install  yarn  -g
yarn add --dev electron@36.1.0
...
![image-20240928151855303](./imgs/image.png)
...
+ 此仓库为二开地址，如需基础代码，请移步 [Gitee](https://gitee.com/haodong108/dy-barrage-grab) ，参与Issues讨论
